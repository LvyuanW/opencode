...
export const dict = {
  ...
  "command.review.toggle.writer": "切换修订",
  ...
  "prompt.writer_example.1": "根据这个 premise 设计一个三幕式长片大纲",
  "prompt.writer_example.2": "为这几个角色写一场紧张对峙戏",
  "prompt.writer_example.3": "把这段对白改得更有潜台词",
  "prompt.writer_example.4": "为主要角色建立人物小传",
  "prompt.writer_example.5": "检查这版稿子里的连续性问题",
  "prompt.writer_example.6": "把这些故事笔记整理成场景卡",
  "prompt.writer_example.7": "加强主角在这一集里的弧光",
  "prompt.writer_example.8": "润色这场戏，但不要改变原意",
  "prompt.writer_example.9": "为这个故事生成三个不同结尾",
  "prompt.writer_example.10": "把这份 beat sheet 扩写成试播集大纲",
  ...
  "prompt.context.pending.one": "1 条待处理批注",
  "prompt.context.pending.other": "{{count}} 条待处理批注",
  "prompt.context.removeActiveFile": "从上下文移除活动文件",
  "prompt.context.removeFile": "从上下文移除文件",
  "prompt.action.attachFile": "附加文件",
  "prompt.action.manageSkills": "管理技能",
  ...
  "toast.comment.added.title": "批注已加入对话",
  ...
  "toast.context.noTextSelection.title": "未选中文本",
  "toast.context.noTextSelection.description": "请先在文稿里选中一段内容。",
  "toast.context.selectionAdded.title": "已锁定这段内容",
  "toast.context.selectionAdded.description": "现在可以去左侧对话里告诉 AI 要怎么改。",
  "toast.context.noReply.title": "还没有可应用的回答",
  "toast.context.noReply.description": "等 AI 给出改写结果后再应用。",
  "toast.context.applyFailed.title": "无法应用到原选区",
  "toast.context.applyFailed.description": "这段原文已经变了，请重新选中后再试。",
  "toast.context.applied.title": "已应用到选区",
  ...
  "home.empty.description": "从打开一部作品开始",

  "session.tab.session": "对话",
  "session.tab.review": "审查",
  "session.tab.revision": "修订",
  "session.tab.context": "上下文",
  "session.panel.reviewAndFiles": "审查和文件",
  "session.panel.revisionAndFiles": "修订与文稿",
  ...
  "session.files.action.newFile": "新建文件",
  "session.files.action.newFolder": "新建文件夹",
  "session.files.action.deleteFile": "删除文件",
  "session.files.action.deleteFolder": "删除文件夹",
  "session.files.dialog.name": "名称",
  "session.files.dialog.create": "创建",
  "session.files.dialog.invalidName": "名称不能包含空片段、. 或 ..",
  "session.files.dialog.newFile.placeholder": "示例.md",
  "session.files.dialog.newFolder.placeholder": "新建文件夹",
  "session.files.dialog.deleteFile.confirm": "删除文件“{{name}}”？",
  "session.files.dialog.deleteFolder.confirm": "删除文件夹“{{name}}”及其全部内容？",
  "session.revision.filesChanged": "{{count}} 处修订",
  "session.revision.change.one": "处修订",
  "session.revision.change.other": "处修订",
  "session.revision.loadingChanges": "正在加载修订...",
  "session.revision.empty": "这个对话里没有待确认修订",
  "session.revision.empty.turn": "最新一轮没有待确认修订",
  "session.revision.unavailable": "当前文稿暂不支持修订对比",
  "session.revision.noSnapshot": "已关闭修订跟踪，因此无法查看修订",
  "session.revision.noChanges": "暂无修订",
  "session.revision.done": "这个对话里的修订都已确认",
  "session.revision.action.confirm": "确认当前列表",
  "session.revision.action.restore": "恢复已确认",
  "session.revision.confirmed.one": "已确认 1 处修订",
  "session.revision.confirmed.other": "已确认 {{count}} 处修订",
  "session.revision.restored": "已恢复这个对话的已确认修订",
  "session.files.selectToOpen.writer": "选择要打开的文稿",
  "session.files.all.writer": "全部文稿",
  "session.files.empty.writer": "还没有文稿",
  "session.file.mode.preview": "预览",
  "session.file.selection.current": "当前选区",
  "session.file.selection.target": "已锁定改写目标",
  "session.file.selection.arm": "交给 AI",
  "session.file.selection.apply": "应用上一条回答",
  "session.file.selection.clear": "清除目标",
  ...
  "session.new.title.writer": "开始写下一场戏",
  "session.new.worktree.main": "主分支",
  "session.new.worktree.mainWithBranch": "主分支（{{branch}}）",
  "session.new.worktree.create": "创建新的 worktree",
  "session.new.lastModified": "最后修改",
  "writer.skills.title": "写作技能",
  "writer.skills.description": "writer 模式下只会加载这个个人工作区里的技能。",
  "writer.skills.root": "技能目录：{{path}}",
  "writer.skills.empty": "还没有技能。你可以上传一个技能文件夹，或直接上传单个 SKILL.md。",
  "writer.skills.upload.folder": "上传文件夹",
  "writer.skills.upload.file": "上传文件",
  "writer.skills.uploading": "上传中",
  "writer.skills.upload.invalid.title": "缺少 SKILL.md",
  "writer.skills.upload.invalid.description": "所选文件夹里至少要包含一个 SKILL.md 文件。",
  "writer.skills.upload.success.title": "技能已更新",
  "writer.skills.upload.success.description": "这个个人工作区里的写作技能已经可以使用。",
  "writer.skills.upload.failed.title": "上传技能失败",
  "writer.skills.delete.success.title": "技能已删除",
  "writer.skills.delete.success.description": "写作技能列表已更新。",
  "writer.skills.delete.failed.title": "删除技能失败",
  "writer.files.upload": "上传文件",
  "writer.files.upload.invalid.title": "仅支持文本文件",
  "writer.files.upload.invalid.description": "writer 模式会把上传内容作为纯文本保存到当前个人工作区。",
  "writer.files.upload.success.title": "文件已上传",
  "writer.files.upload.success.description": "已将 {{count}} 个文件放入当前个人工作区。",
  "writer.files.upload.failed.title": "上传文件失败",
  "writer.files.hidden.description": ".skills 文件夹请通过聊天框下方的技能按钮管理。",
  "writer.home.placeholder": "工作空间 ID",
  "writer.home.required": "请输入 ID 后继续。",
  "writer.home.unavailable": "当前还没有可用的写作工作空间根目录。",
  "writer.home.back": "返回主页",
  ...
  "sidebar.workspaces.enable.writer": "显示分稿",
  "sidebar.workspaces.disable.writer": "隐藏分稿",
  ...
  "settings.general.row.workspaceMode.title": "工作模式",
  "settings.general.row.workspaceMode.description": "在代码优先与写作优先的默认界面之间切换",
  "settings.general.row.workspaceMode.option.code": "代码",
  "settings.general.row.workspaceMode.option.writer": "写作",
  ...
  "ui.sessionReview.title": "会话更改",
  "ui.sessionReview.title.lastTurn": "上一轮",
  "ui.sessionRevision.title": "待确认修订",
  "ui.sessionRevision.title.lastTurn": "最新一轮",
  ...
  "workspace.type.local.writer": "主稿",
  "workspace.type.sandbox.writer": "分稿",
