...
export const dict = {
  ...
  "command.review.toggle.writer": "切換修訂",
  ...
  "prompt.writer_example.1": "根據這個 premise 規劃一個三幕式長片大綱",
  "prompt.writer_example.2": "為這幾個角色寫一場緊張對峙戲",
  "prompt.writer_example.3": "把這段對白改得更有潛台詞",
  "prompt.writer_example.4": "為主要角色建立人物小傳",
  "prompt.writer_example.5": "檢查這版稿子的連續性問題",
  "prompt.writer_example.6": "把這些故事筆記整理成場景卡",
  "prompt.writer_example.7": "加強主角在這一集裡的弧光",
  "prompt.writer_example.8": "潤飾這場戲，但不要改變原意",
  "prompt.writer_example.9": "為這個故事生成三個不同結尾",
  "prompt.writer_example.10": "把這份 beat sheet 擴寫成試播集大綱",
  ...
  "prompt.context.pending.one": "1 條待處理批註",
  "prompt.context.pending.other": "{{count}} 條待處理批註",
  ...
  "toast.comment.added.title": "批註已加入對話",
  ...
  "toast.context.noTextSelection.title": "未選取文字",
  "toast.context.noTextSelection.description": "請先在文稿裡選取一段內容。",
  "toast.context.selectionAdded.title": "已鎖定這段內容",
  "toast.context.selectionAdded.description": "現在可以去左側對話裡告訴 AI 要怎麼改。",
  "toast.context.noReply.title": "還沒有可套用的回答",
  "toast.context.noReply.description": "等 AI 給出改寫結果後再套用。",
  "toast.context.applyFailed.title": "無法套用到原選區",
  "toast.context.applyFailed.description": "這段原文已經變了，請重新選取後再試。",
  "toast.context.applied.title": "已套用到選區",
  ...
  "home.empty.title": "還沒有作品",
  "home.empty.description": "從打開一部作品開始",

  "session.tab.session": "對話",
  "session.tab.review": "審查",
  "session.tab.revision": "修訂",
  "session.tab.context": "上下文",
  "session.panel.reviewAndFiles": "審查與檔案",
  "session.panel.revisionAndFiles": "修訂與文稿",
  ...
  "session.revision.filesChanged": "{{count}} 處修訂",
  "session.revision.change.one": "處修訂",
  "session.revision.change.other": "處修訂",
  "session.revision.loadingChanges": "正在載入修訂...",
  "session.revision.empty": "這個對話裡沒有待確認修訂",
  "session.revision.empty.turn": "最新一輪沒有待確認修訂",
  "session.revision.unavailable": "目前文稿暫不支援修訂比對",
  "session.revision.noSnapshot": "已關閉修訂追蹤，因此無法查看修訂",
  "session.revision.noChanges": "暫無修訂",
  "session.revision.done": "這個對話裡的修訂都已確認",
  "session.revision.action.confirm": "確認目前列表",
  "session.revision.action.restore": "恢復已確認",
  "session.revision.confirmed.one": "已確認 1 處修訂",
  "session.revision.confirmed.other": "已確認 {{count}} 處修訂",
  "session.revision.restored": "已恢復這個對話的已確認修訂",
  "session.files.selectToOpen.writer": "選擇要開啟的文稿",
  "session.files.all.writer": "全部文稿",
  "session.files.empty.writer": "還沒有文稿",
  "session.file.mode.preview": "預覽",
  "session.file.selection.current": "目前選區",
  "session.file.selection.target": "已鎖定改寫目標",
  "session.file.selection.arm": "交給 AI",
  "session.file.selection.apply": "套用上一條回答",
  "session.file.selection.clear": "清除目標",
  ...
  "session.new.title.writer": "開始寫下一場戲",
  "session.new.worktree.main": "主分支",
  "session.new.worktree.mainWithBranch": "主分支 ({{branch}})",
  "session.new.worktree.create": "建立新的 worktree",
  "session.new.lastModified": "最後修改",
  "writer.skills.title": "寫作技能",
  "writer.skills.description": "writer 模式下只會載入這個個人工作區裡的技能。",
  "writer.skills.root": "技能目錄：{{path}}",
  "writer.skills.empty": "還沒有技能。你可以上傳技能資料夾，或直接上傳單個 SKILL.md。",
  "writer.skills.upload.folder": "上傳資料夾",
  "writer.skills.upload.file": "上傳檔案",
  "writer.skills.uploading": "上傳中",
  "writer.skills.upload.invalid.title": "缺少 SKILL.md",
  "writer.skills.upload.invalid.description": "所選資料夾裡至少要包含一個 SKILL.md 檔案。",
  "writer.skills.upload.success.title": "技能已更新",
  "writer.skills.upload.success.description": "這個個人工作區裡的寫作技能已經可以使用。",
  "writer.skills.upload.failed.title": "上傳技能失敗",
  "writer.skills.delete.success.title": "技能已刪除",
  "writer.skills.delete.success.description": "寫作技能清單已更新。",
  "writer.skills.delete.failed.title": "刪除技能失敗",
  "writer.files.upload": "上傳檔案",
  "writer.files.upload.invalid.title": "僅支援文字檔案",
  "writer.files.upload.invalid.description": "writer 模式會把上傳內容作為純文字儲存到目前個人工作區。",
  "writer.files.upload.success.title": "檔案已上傳",
  "writer.files.upload.success.description": "已將 {{count}} 個檔案放入目前個人工作區。",
  "writer.files.upload.failed.title": "上傳檔案失敗",
  "writer.files.hidden.description": ".skills 資料夾請透過聊天框下方的技能按鈕管理。",
  "writer.home.placeholder": "工作空間 ID",
  "writer.home.required": "請先輸入 ID。",
  "writer.home.unavailable": "目前還沒有可用的寫作工作空間根目錄。",
  "writer.home.back": "返回主頁",
  ...
  "sidebar.workspaces.enable.writer": "顯示分稿",
  "sidebar.workspaces.disable.writer": "隱藏分稿",
  ...
  "settings.general.row.workspaceMode.description": "在程式碼優先與寫作優先的預設介面之間切換",
  "settings.general.row.workspaceMode.option.code": "程式碼",
  "settings.general.row.workspaceMode.option.writer": "寫作",
  ...
  "ui.sessionReview.title.lastTurn": "上一輪",
  "ui.sessionRevision.title": "待確認修訂",
  "ui.sessionRevision.title.lastTurn": "最新一輪",
