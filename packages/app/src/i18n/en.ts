export const dict = {
  ...
  "command.project.open": "Open work",
  ...
  "command.review.toggle.writer": "Toggle revisions",
  ...
  "prompt.writer_example.1": "Outline a three-act feature from this premise",
  "prompt.writer_example.2": "Write a tense confrontation scene between these characters",
  "prompt.writer_example.3": "Rewrite this dialogue with more subtext",
  "prompt.writer_example.4": "Build character bios for the main cast",
  "prompt.writer_example.5": "Check this draft for continuity problems",
  "prompt.writer_example.6": "Turn these story notes into scene cards",
  "prompt.writer_example.7": "Strengthen the protagonist's arc across the episode",
  "prompt.writer_example.8": "Polish this scene without changing the meaning",
  "prompt.writer_example.9": "Generate three alternate endings for this story",
  "prompt.writer_example.10": "Expand this beat sheet into a pilot outline",
  ...
  "prompt.context.pending.one": "1 pending note",
  "prompt.context.pending.other": "{{count}} pending notes",
  "prompt.context.removeActiveFile": "Remove active file from context",
  "prompt.context.removeFile": "Remove file from context",
  "prompt.action.attachFile": "Add file",
  "prompt.action.manageSkills": "Manage skills",
  ...
  "toast.comment.added.title": "Note added to chat",
  "toast.file.saveFailed.title": "Failed to save file",
  "toast.file.saved.title": "Saved file",

  "toast.context.noLineSelection.title": "No line selection",
  "toast.context.noLineSelection.description": "Select a line range in a file tab first.",
  "toast.context.noTextSelection.title": "No text selected",
  "toast.context.noTextSelection.description": "Select a passage in the draft first.",
  "toast.context.selectionAdded.title": "Locked this passage",
  "toast.context.selectionAdded.description": "Now tell the AI on the left how you want it changed.",
  "toast.context.noReply.title": "No reply to apply yet",
  "toast.context.noReply.description": "Wait for the AI to answer before applying.",
  "toast.context.applyFailed.title": "Could not apply to the original passage",
  "toast.context.applyFailed.description": "That passage has changed. Select it again and retry.",
  "toast.context.applied.title": "Applied to selection",
  ...
  "home.recentProjects": "Recent works",
  "home.empty.title": "No recent works",
  "home.empty.description": "Start by opening a work",

  "session.tab.session": "Chat",
  "session.tab.review": "Review",
  "session.tab.revision": "Revisions",
  "session.tab.context": "Context",
  "session.panel.reviewAndFiles": "Review and files",
  "session.panel.revisionAndFiles": "Revisions and drafts",
  ...
  "session.revision.filesChanged": "{{count}} revisions",
  "session.revision.change.one": "revision",
  "session.revision.change.other": "revisions",
  "session.revision.loadingChanges": "Loading revisions...",
  "session.revision.empty": "No pending revisions in this chat",
  "session.revision.empty.turn": "No pending revisions in the latest turn",
  "session.revision.unavailable": "Revision compare is not available for this draft yet",
  "session.revision.noSnapshot": "Revision tracking is disabled, so revisions are unavailable",
  "session.revision.noChanges": "No revisions",
  "session.revision.done": "All revisions in this chat are confirmed",
  "session.revision.action.confirm": "Confirm shown",
  "session.revision.action.restore": "Restore confirmed",
  "session.revision.confirmed.one": "Confirmed 1 revision",
  "session.revision.confirmed.other": "Confirmed {{count}} revisions",
  "session.revision.restored": "Restored confirmed revisions in this chat",

  "session.files.selectToOpen": "Select a file to open",
  "session.files.all": "All files",
  "session.files.empty": "No files",
  "session.files.binaryContent": "Binary file (content cannot be displayed)",
  "session.files.action.newFile": "New file",
  "session.files.action.newFolder": "New folder",
  "session.files.action.deleteFile": "Delete file",
  "session.files.action.deleteFolder": "Delete folder",
  "session.files.dialog.name": "Name",
  "session.files.dialog.create": "Create",
  "session.files.dialog.invalidName": "Name cannot include empty segments, . or ..",
  "session.files.dialog.newFile.placeholder": "example.md",
  "session.files.dialog.newFolder.placeholder": "new-folder",
  "session.files.dialog.deleteFile.confirm": 'Delete file "{{name}}"?',
  "session.files.dialog.deleteFolder.confirm": 'Delete folder "{{name}}" and its contents?',
  "session.files.selectToOpen.writer": "Choose a draft to open",
  "session.files.all.writer": "All drafts",
  "session.files.empty.writer": "No drafts yet",
  "session.file.mode.preview": "Preview",
  "session.file.selection.current": "Current selection",
  "session.file.selection.target": "Locked edit target",
  "session.file.selection.arm": "Ask AI",
  "session.file.selection.apply": "Apply last reply",
  "session.file.selection.clear": "Clear target",
  ...
  "session.new.title.writer": "Write your next scene",
  "session.new.worktree.main": "Main branch",
  "session.new.worktree.mainWithBranch": "Main branch ({{branch}})",
  "session.new.worktree.create": "Create new worktree",
  "session.new.lastModified": "Last modified",
  "writer.skills.title": "Writer skills",
  "writer.skills.description": "Only the skills in this personal workspace are available in writer mode.",
  "writer.skills.root": "Skill folder: {{path}}",
  "writer.skills.empty": "No skills yet. Upload a skill folder or a single SKILL.md to get started.",
  "writer.skills.upload.folder": "Upload folder",
  "writer.skills.upload.file": "Upload file",
  "writer.skills.uploading": "Uploading",
  "writer.skills.upload.invalid.title": "Missing SKILL.md",
  "writer.skills.upload.invalid.description": "The selected folder must contain at least one SKILL.md file.",
  "writer.skills.upload.success.title": "Skills updated",
  "writer.skills.upload.success.description": "Writer skills are ready in this workspace.",
  "writer.skills.upload.failed.title": "Failed to upload skills",
  "writer.skills.delete.success.title": "Skill removed",
  "writer.skills.delete.success.description": "The writer skill list has been updated.",
  "writer.skills.delete.failed.title": "Failed to delete skill",
  "writer.files.upload": "Upload file",
  "writer.files.upload.invalid.title": "Only text files are supported",
  "writer.files.upload.invalid.description": "Writer uploads save plain text files into this personal workspace.",
  "writer.files.upload.success.title": "Files uploaded",
  "writer.files.upload.success.description": "{{count}} files are ready in this workspace.",
  "writer.files.upload.failed.title": "Failed to upload files",
  "writer.files.hidden.description": "The .skills folder is managed from the composer skill button.",
  "writer.home.placeholder": "Workspace ID",
  "writer.home.required": "Enter an ID to continue.",
  "writer.home.unavailable": "The writer workspace root is not available yet.",
  "writer.home.back": "Home",
  ...
  "sidebar.nav.projectsAndSessions": "Works and chats",
  "sidebar.writer.history": "Chat history",
  "sidebar.settings": "Settings",
  "sidebar.help": "Help",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.workspaces.enable.writer": "Show draft branches",
  "sidebar.workspaces.disable.writer": "Hide draft branches",
  ...
  "ui.sessionRevision.title": "Pending revisions",
  "ui.sessionRevision.title.lastTurn": "Latest turn",
  ...
  "settings.general.row.workspaceMode.title": "Workspace mode",
  "settings.general.row.workspaceMode.description": "Switch between coding and writing-focused defaults",
  "settings.general.row.workspaceMode.option.code": "Code",
  "settings.general.row.workspaceMode.option.writer": "Writing",
  ...
  "workspace.type.local.writer": "Draft",
  "workspace.type.sandbox.writer": "Alt draft",
