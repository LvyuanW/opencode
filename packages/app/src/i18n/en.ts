export const dict = {
  ...
  "session.panel.revisionAndFiles": "Revisions and files",
  ...
  "session.revision.filesChanged": "{{count}} Revised Files",
  "session.revision.change.one": "Revised file",
  "session.revision.change.other": "Revised files",
  "session.revision.loadingChanges": "Loading revisions...",
  "session.revision.empty": "No revisions in this session yet",
  "session.revision.unavailable": "Revision compare is not available for this workspace yet",
  "session.revision.noSnapshot": "Revision tracking is disabled in config, so revision compare is unavailable",
  ...
  "ui.sessionRevision.title": "Session revisions",
  ...
  "settings.general.row.workspaceMode.option.writer": "Writer",
